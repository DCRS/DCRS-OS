...
def zero_plugins():
    ...
    plugin_realsrc=os.environ['SNAP']+"/zeronet/plugins"
    plugin_src="/snap/dcrs/current/zeronet/plugins"
    plugin_dest=os.environ['SNAP_USER_COMMON']+"/zeronet/plugins"
...
def link(src_):
    src="/snap/dcrs/current/zeronet/"+src_
    dst=os.environ['SNAP_USER_COMMON']+"/zeronet/"+src_
...
def zero_start():
    ...
    setarg("--config_file", os.environ['SNAP_USER_COMMON']+"/zeronet/zeronet.conf")
